...
namespace eShopLabs.Services.Catalog.API.Grpc
{
    public class CatalogService : CatalogBase
    {
        ...
        {
            _logger.LogInformation("Begin grpc call GatalogService.GetItemById for product id {Id}", request.Id);
        ...
        private PaginatedItemsResponse MapToResponse(List<CatalogItem> items, long count, int pageIndex, int pageSize)
        {
            ...
            items.ForEach(i =>
            {
                var brand = i.CatalogBrand is null ? null :
                    new CatalogApi.CatalogBrand { Id = i.CatalogBrand.Id, Name = i.CatalogBrand.Brand };

                var catalogType = i.CatalogType is null ? null :
                    new CatalogApi.CatalogType { Id = i.CatalogType.Id, Type = i.CatalogType.Type };
