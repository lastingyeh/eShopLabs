...
using eShopLabs.BuildingBlocks.EventBus.Extensions;
    ...
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        ...
        private void StartBasicConsume()
        {
            ...
            if (_consumerChannel != null)
            {
                ...
                _consumerChannel.BasicConsume(queue: _queueName, autoAck: false, consumer);
            }
            else
            {
                _logger.LogError("StartBasicConsume can't call on_consumerChannel is null");
            }
        }
        ...
        private async Task ProcessEvent(string eventName, string message)
        {
            ...
            {
                _logger.LogWarning("No subscriptioin for RabbitMQ event: {EventName}", eventName);
            }
        }
        ...
        public void Publish(IntegrationEvent @event)
        {
            ...
            policy.Execute(() =>
            {
                ...
                channel.BasicPublish(exchange: BROKER_NAME, routingKey: eventName, mandatory: true, basicProperties: properties, body);
            });
        }
